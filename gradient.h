enum gradient {
	BLUE_CYAN, INFERNO, BLACK_BODY, CMOCEAN_ICE,
	KINDLMANN, VIRIDIS, PLASMA,
...
double gradients[NUM_GRADIENTS][GN][3] = {
	...
	//
	[CMOCEAN_ICE] = {{93, 57, 139}, {119, 84, 165}, {145, 110, 191}, {159, 140, 214}, {173, 171, 238}, {185, 195, 237}, {197, 219, 236}, {207, 237, 232}},
	[BLUE_CYAN] = {{69, 20, 96}, {60, 50, 105}, {51, 81, 114}, {54, 105, 120}, {57, 129, 127}, {78, 148, 110}, {98, 167, 92}, {134, 180, 67}},
};
